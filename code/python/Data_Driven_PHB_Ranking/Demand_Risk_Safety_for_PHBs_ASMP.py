...
# ***CHURCHES***
print("\n" + "Churches: Generate Near Table, Frequency, Add Index")
...
# ***PARKS***
print("\n" + "Parks: Generate Near Table, Frequency, Add Index")
...
# ***LARGE OFFICE***
print("\n" + "Large Office: Generate Near Table, Frequency, Add Index")
...
print("\n" + "Multi-Family Housing: Generate Near Table, Add Index")
...
# ***SOCIAL SERVICES***
print("\n" + "Social Services: Generate Near Table, Frequency, Add Index")
...
# ***PHB REQUESTS - CSR***
print("\n" + "PHB Requests - CSR: Generate Near Table, Join Field to Signal_Requests_PHB to get additional fields, Add Index")
...
# ***STREETLIGHTS***
print("\n" + "Streetlights: Generate Near Table, Add Index")
...
# ***SIGNALS***
print("\n" + "Signals: Generate Near Table, Add Index")
...
print("\n" + "Pedestrian Crashes 200': Generate Near Table, Frequency, Add Index")
...
print("\n" + "Pedestrian Crashes 400': Generate Near Table, Frequency, Add Index")
