...
arcpy.CalculateField_management("HH_Income_Layer", "Median_Number", "!HH_Income_Total! / 2", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
...
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_15k", "!Count_less_than_10k! + !Total_10k_to_15k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_20k", "!Count_less_than_15k! + !Total_15k_to_20k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_25k", "!Count_less_than_20k! + !Total_20k_to_25k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_30k", "!Count_less_than_25k! + !Total_25k_to_30k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_35k", "!Count_less_than_30k! + !Total_30k_to_35k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_40k", "!Count_less_than_35k! + !Total_35k_to_40k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_45k", "!Count_less_than_40k! + !Total_40k_to_45k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_50k", "!Count_less_than_45k! + !Total_45k_to_50k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_60k", "!Count_less_than_50k! + !Total_50k_to_60k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_75k", "!Count_less_than_60k! + !Total_60k_to_75k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_100k", "!Count_less_than_75k! + !Total_75k_to_100k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_125k", "!Count_less_than_100k! + !Total_100k_to_125k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_150k", "!Count_less_than_125k! + !Total_125k_to_150k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Count_less_than_200k", "!Count_less_than_150k! + !Total_150k_to_200k!", "PYTHON_9.3", "")
print "\n", arcpy.GetMessages()
...
arcpy.CalculateField_management("HH_Income_Layer", "Less_than_10k", "CalcField(!Count_less_than_10k!,!Median_Number!)", "PYTHON_9.3", lessCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_10k_15k", "CalcField(!Count_less_than_15k!,!Median_Number!,!Count_less_than_10k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_15k_20k", "CalcField(!Count_less_than_20k!,!Median_Number!,!Count_less_than_15k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_20k_25k", "CalcField(!Count_less_than_25k!,!Median_Number!,!Count_less_than_20k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_25k_30k", "CalcField(!Count_less_than_30k!,!Median_Number!,!Count_less_than_25k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_30k_35k", "CalcField(!Count_less_than_35k!,!Median_Number!,!Count_less_than_30k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_35k_40k", "CalcField(!Count_less_than_40k!,!Median_Number!,!Count_less_than_35k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_40k_45k", "CalcField(!Count_less_than_45k!,!Median_Number!,!Count_less_than_40k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_45k_50k", "CalcField(!Count_less_than_50k!,!Median_Number!,!Count_less_than_45k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_50k_60k", "CalcField(!Count_less_than_60k!,!Median_Number!,!Count_less_than_50k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_60k_75k", "CalcField(!Count_less_than_75k!,!Median_Number!,!Count_less_than_60k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_75k_100k", "CalcField(!Count_less_than_100k!,!Median_Number!,!Count_less_than_75k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_100k_125k", "CalcField(!Count_less_than_125k!,!Median_Number!,!Count_less_than_100k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_125k_150k", "CalcField(!Count_less_than_150k!,!Median_Number!,!Count_less_than_125k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Btwn_150k_200k", "CalcField(!Count_less_than_200k!,!Median_Number!,!Count_less_than_150k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
arcpy.CalculateField_management("HH_Income_Layer", "Greater_than_200k", "CalcField(!Count_greater_than_200k!,!Median_Number!,!Count_less_than_200k!)", "PYTHON_9.3", btwnGreaterCodeblock)
print "\n", arcpy.GetMessages()
